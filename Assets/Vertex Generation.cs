...
public class VertexGeneration : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        faceMesh.vertices = new Vector3[] { new Vector3( gr,   0,  -1),  //rectangle x point 1
           ...
           faceMesh.triangles = new int[] { 0, 9, 5 };
    }

    /*vertexes need to be in a specific order
    //20 TRIANGLES, vertices are in clockwise order


    //triangles around point 0
    0, 9, 5
    0, 5, 3
    0, 3, 4
    0, 4, 8
